...
export interface ClusterGatewayRouteDto { 
    /**
     ...
     */
    service: string;
    endpointType: ClusterGatewayRouteDto.EndpointTypeEnum;
    /**
     * True when HTTPS is active on the route.
     */
    tlsEnabled: boolean;
    certificateStatus?: ClusterGatewayRouteDto.CertificateStatusEnum;
    auth?: GatewayAuthPolicyDto;
    rateLimit?: GatewayRateLimitPolicyDto;
    allowIps?: Array<string>;
    reconciliationStatus: ClusterGatewayRouteDto.ReconciliationStatusEnum;
    /**
...
export namespace ClusterGatewayRouteDto {
